...
namespace ScintillaNET
{
    ...
    public class Commands : TopLevelHelper
    {
        ...
        internal Commands(Scintilla scintilla) : base(scintilla)
        {
            ...
            AddBinding(Keys.Oemplus, Keys.Control, BindableCommand.ZoomIn);
            AddBinding(Keys.Subtract, Keys.Control, BindableCommand.ZoomOut);
            AddBinding(Keys.OemMinus , Keys.Control, BindableCommand.ZoomOut);
            AddBinding(Keys.D0, Keys.Control, BindableCommand.SetZoom);
            AddBinding(Keys.NumPad0, Keys.Control, BindableCommand.SetZoom);
