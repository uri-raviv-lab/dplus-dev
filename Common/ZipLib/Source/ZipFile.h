...
class ZipFile
{
  ...
  public:
     ...
     */
    static void AddFile(const std::string& zipPath, const std::string& fileName, ICompressionMethod::Ptr method = StoreMethod::Create());
     ...
     * \param level         (Optional) The level of compression. Use CompressionLevel::Stored for no compression.
     */
    static void AddFile(const std::string& zipPath, const std::string& fileName, const std::string& inArchiveName, ICompressionMethod::Ptr method = StoreMethod::Create());
     ...
     * \param level     (Optional) The level of compression. Use CompressionLevel::Stored for no compression.
     */
    static void AddEncryptedFile(const std::string& zipPath, const std::string& fileName, const std::string& password, ICompressionMethod::Ptr method = StoreMethod::Create());
     ...
     * \param level         (Optional) The level of compression. Use CompressionLevel::Stored for no compression.
     */
    static void AddEncryptedFile(const std::string& zipPath, const std::string& fileName, const std::string& inArchiveName, const std::string& password, ICompressionMethod::Ptr method = StoreMethod::Create());
