...
static cl_mem  (*clCreateFromGLBuffer_ptr)(cl_context     , cl_mem_flags   , GLuint         , int *          ) = NULL;
...
static cl_mem  (*clCreateFromGLTexture2D_ptr)(cl_context      , cl_mem_flags    , GLenum          , GLint           , GLuint          , cl_int *        ) = NULL;
cl_mem  clCreateFromGLTexture2D (cl_context       context ,cl_mem_flags     flags ,GLenum           target ,GLint            miplevel ,GLuint           texture ,cl_int *         errcode_ret ) {
...
static cl_mem  (*clCreateFromGLTexture3D_ptr)(cl_context      , cl_mem_flags    , GLenum          , GLint           , GLuint          , cl_int *        ) = NULL;
cl_mem  clCreateFromGLTexture3D (cl_context       context ,cl_mem_flags     flags ,GLenum           target ,GLint            miplevel ,GLuint           texture ,cl_int *         errcode_ret ) {
...
static cl_mem  (*clCreateFromGLRenderbuffer_ptr)(cl_context   , cl_mem_flags , GLuint       , cl_int *     ) = NULL;
...
static cl_int  (*clGetGLObjectInfo_ptr)(cl_mem                , cl_gl_object_type *   , GLuint *              ) = NULL;
