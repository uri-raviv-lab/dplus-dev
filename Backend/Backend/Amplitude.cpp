...
#pragma region Electron atomic form factor coefficients
	// I'm almost certain we can delete this part of the code 
...
{
	return DebyeCalTester::atomicFF(q, elem) + fPrime + std::complex<F_TYPE>(0, 1) * fPrimePrime;
}
