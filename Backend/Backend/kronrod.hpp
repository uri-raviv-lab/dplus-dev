...
EXPORTED_BE void kronrod ( int n, double eps, double x[], double w1[], double w2[] );
EXPORTED_BE void kronrod_adjust ( double a, double b, int n, double x[], double w1[], double w2[] );
double r8_epsilon ( );
void timestamp ( );
