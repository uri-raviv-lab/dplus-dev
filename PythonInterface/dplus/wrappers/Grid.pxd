...
cdef extern from r"Backend/Backend/backend_exception.cpp":
    pass
...
cdef extern from r"Backend/Backend/Grid.h" :
    cdef cppclass JacobianSphereGrid:
        ...
        double CalculateIntensity(double q, double epsi, unsigned int seed, unsigned long long iterations, double phi_min, double phi_max) except +
        double CalculateIntensity(double q, double theta, double epsi, unsigned int seed, unsigned long long iterations, double phi_min, double phi_max) except +
