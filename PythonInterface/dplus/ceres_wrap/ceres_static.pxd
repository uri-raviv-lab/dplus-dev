...
cdef extern from r"ceres/types.h" namespace "ceres":
    ...
    ctypedef enum LineSearchInterpolationType:
        BISECTION
        QUADRATIC
        CUBIC
    ...
    ctypedef enum NumericDiffMethodType:
        CENTRAL
        FORWARD
        RIDDERS


cdef extern from r"ceres/ordered_groups.h" namespace "ceres":
...
cdef extern from r"ceres/local_parameterization.h" namespace "ceres":
...
cdef extern from r"ceres/problem.h" namespace "ceres::internal":
...
cdef extern from r"ceres/loss_function.h" namespace "ceres":

    cdef cppclass LossFunction:
        void Evaluate(double sq_norm, double out[3]) const

    cdef cppclass TrivialLoss(LossFunction):
        TrivialLoss()
...
cdef extern from r"ceres/cost_function.h" namespace "ceres":
...
cdef extern from r"ceres/solver.h" namespace "ceres::Solver":
    ...
    cdef cppclass SolverSummary "ceres::Solver::Summary":
        Summary()
...
cdef extern from r"ceres/solver.h" namespace "ceres":

    void Solve(const SolverOptions& options,
                Problem* problem,
                SolverSummary* summary)

cdef extern from r"ceres/problem.h" namespace "ceres":
    ctypedef ResidualBlock* ResidualBlockId
cdef extern from r"ceres/problem.h" namespace "ceres::Problem":
